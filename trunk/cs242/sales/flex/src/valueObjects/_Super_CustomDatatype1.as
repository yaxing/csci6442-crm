...
public class _Super_CustomDatatype1 extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    public function set date_as_customer(value:Date) : void
    {
        ...
        if (oldValue !== value)
        {
            ...
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "date_as_customer", oldValue, _internal_date_as_customer));
        }
    }
    ...
    public function set date_entered(value:Date) : void
    {
        ...
        if (oldValue !== value)
        {
            ...
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "date_entered", oldValue, _internal_date_entered));
        }
    }
    ...
    public function set customer_type(value:String) : void
    {
        ...
        if (oldValue !== value)
        {
            ...
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "customer_type", oldValue, _internal_customer_type));
        }
    }
    ...
    public function set account_name(value:String) : void
    {
        ...
        if (oldValue !== value)
        {
            ...
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "account_name", oldValue, _internal_account_name));
        }
    }
