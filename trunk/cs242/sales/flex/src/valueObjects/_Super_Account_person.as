 ...
 * of this value object you may modify the generated sub-class of this class - Account_person.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Account_person extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _Account_personEntityMetadata;
    ...
    public function _Super_Account_person()
    {
        _model = new _Account_personEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Account_personEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Account_personEntityMetadata) : void
    {
        var oldValue : _Account_personEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
