...
//$requested_completion = "2011-05-02";
	...
	$sql1 = "select contact_location_id,customer from contact,contact_location where contact.contact_id = contact_location.contact_id and contact.contact_id=$applicant"; 
	$db->select($sql1);
