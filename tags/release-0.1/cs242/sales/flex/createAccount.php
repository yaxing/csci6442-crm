...
include_once '../../common/php/db/Database.class.php';     
#endregion include
/*
...
$sql_account = "INSERT INTO account VALUES (null, '".$created_by."', '".$account_name."', '".$website."', '".$datetime."', '".$datetime."','".$customer_type."')"; 
echo $sql_account."\n<br>";
$insertId_account = $db->insert($sql_account);

$sql_account_person = "INSERT INTO account_person VALUES (null, ".$insertId_account.", '".$title."', '".$first_name."', '".$last_name."')";
echo $sql_account_person."\n<br>";
$sql_account_location = "INSERT INTO account_location VALUES (null, '".$zipcode."', '".$address1."', '".$address2."', '".$city."', '".$state."', '".$location_type."')";
...
$sql_account_person_location = "INSERT INTO account_person_location VALUES (".$insertId_account_person.", ".$insertId_account_location.")";
